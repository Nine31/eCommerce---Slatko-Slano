...
export class StripeService {
  ...
  async initializeElements() {
    if (!this.elements) {
      ...
      if (stripe) {
        ...
        throw new Error('Traka nije učitana.');
      }
    }
  ...
  async createPaymentElement() {
    if (!this.paymentElement) {
      ...
      if (elements) {
        ...
        throw new Error('Instanca elemenata nije inicijalizirana');
      }
    }
  ...
  async createAddressElement() {
    if (!this.addressElement) {
      ...
      if (elements) {
        ...
        throw new Error('Instanca elementa nije učitana');
      }
    }
  ...
  async createConfirmationToken() {
    ...
    if (stripe) {
      ...
      throw new Error('Traka nedostupna');
    }
  }
  ...
  async confirmPayment(confirmationToken: ConfirmationToken) {
    ...
    if (stripe && clientSecret) {
      ...
      throw new Error('Nije moguće učitati traku');
    }
  }
  ...
  createOrUpdatePaymentIntent() {
    ...
    if (!cart) throw new Error('Problem sa karticom');
