...
public static class ClaimsPrincipleExtensions
{
    public static async Task<AppUser> GetUserByEmail(this UserManager<AppUser> userManager, ClaimsPrincipal user)
    {
        ...
        if (userToReturn == null) throw new AuthenticationException("Korisnik nije pronađen");
    ...
    {
        var email = user.FindFirstValue(ClaimTypes.Email) ?? throw new AuthenticationException("Email zahtjev nije pronađen");
